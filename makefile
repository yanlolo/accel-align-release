...
IDXSRC=index.cpp embedding.cpp bseq.c index.c kthread.c kalloc.c sketch.c misc.c options.c indexparameters.cpp io.cpp randstrobes.cpp ./ext/xxhash.c pc.cpp sam.cpp cigar.cpp aln.cpp aligner.cpp fastq.cpp nam.cpp paf.cpp cmdline.cpp readlen.cpp refs.cpp ./ext/ssw/ssw_cpp.cpp
HEADERS=$(wildcard *.h)
