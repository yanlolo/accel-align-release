...
public:
    ...
    /* Add an alignment */
    void add(const StrobAlignment& alignment, const klibpp::KSeq& record, const std::string& sequence_rc, bool is_primary, const Details& details);
    void add_pair(const StrobAlignment& alignment1, const StrobAlignment& alignment2, const klibpp::KSeq& record1, const klibpp::KSeq& record2, const std::string& read1_rc, const std::string& read2_rc, uint8_t mapq1, uint8_t mapq2, bool is_proper, bool is_primary, const std::array<Details, 2>& details);
...
bool is_proper_pair(const StrobAlignment& alignment1, const StrobAlignment& alignment2, float mu, float sigma);
