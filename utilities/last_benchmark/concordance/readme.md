...
workspace=/home/yiqing
r1=$workspace/yan/input/BIO150/4A1_CGATGT_L001_R1_001_small.fastq
r2=$workspace/yan/input/BIO150/4A1_CGATGT_L001_R2_001_small.fastq
output=$workspace/yan/output-bio150

workspace=/home/yiqing
r1=$workspace/yan/input/BIO250/D3_S1_L001_R1_001_small.fastq
r2=$workspace/yan/input/BIO250/D3_S1_L001_R2_001_small.fastq
...
workspace=/home/yiqing
r1=$workspace/yan/input/BIO250/D3_S1_L001_R1_001.fastq
r2=$workspace/yan/input/BIO250/D3_S1_L001_R2_001.fastq
output=$workspace/yan/output-bio250
...
aligner=accalign
time $workspace/code/accel-align-release/accalign-cano -I H -l 21 -t $nthreads -o $output/${aligner}-cano-21-150.sam \
...
aligner=accalign
time $workspace/code/accel-align-release/accalign -I H -l $kmer -t $nthreads -o $output/${aligner}-cano-${kmer}-150.sam \
$workspace/data/fsva-hg37/hg37.fna $r1 $r2 > log-${kmer}-150
...
aligner=accalign
time $workspace/code/accel-align-release/accalign -I H -l $kmer -t $nthreads -o $output/${aligner}-cano-${kmer}-250.sam \
$workspace/data/fsva-hg37/hg37.fna $r1 $r2 > log-${kmer}-250
...
aligner=accalign
time $workspace/code/accel-align-release/accalign -I H -l $kmer -t $nthreads -o $output/${aligner}-non-cano-${kmer}-150.sam \
$workspace/data/fsva-hg37/hg37.fna $r1 $r2 > log-non-cano-${kmer}-150
...
aligner=accalign
time $workspace/code/accel-align-release/accalign -I H -l $kmer -t $nthreads -o $output/${aligner}-non-cano-${kmer}-250.sam \
$workspace/data/fsva-hg37/hg37.fna $r1 $r2 > log-non-cano-${kmer}-250
