...
//  std::vector<uint32_t> &offset;
  ...
  void find_candidate_positions_using_strobealign(std::string_view seq, vector<Region> &fcandidate_regions, bool forward, StrobemerIndex &index, IndexParameters& index_parameters);
